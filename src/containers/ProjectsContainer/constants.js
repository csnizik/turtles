export const projectCards = [
  ...
  },
  {
    ...
    paragraphText:
      'Conservation Innovation Grants description lorum ipsum dolor sit amet, consectetur adipiscing elit. Aenean vehicula diam ediam tempor fringilla.',
    imgSrc:
      'https://gisgeography.com/wp-content/uploads/2020/07/US-Elevation-Map-1550x925.jpg',
    imgAlt: 'Map of the United States of America - Terrain View',
  },
];

export const projectListGroups = [
  { id: 0, title: 'All U.S. Projects & Initiatives' },
  { id: 1, title: 'Conservation Innovation Grants' },
