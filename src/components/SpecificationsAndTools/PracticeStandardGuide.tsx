...
const PracticeStandardGuide = ( {
  ...
  return (
    <div className='practice-standard-steps' data-testid='practice-standard-steps'>
      <h4>{practiceStandardGuideText.title}</h4>
      <h4>{practiceStandardGuideText.firstStep}
        <a
          href={practiceLink}
          target='_blank'
      ...
      <button type='button' onClick={() => handleClick()} className='close-instruction-button'>Close Instrutions</button>
    </div>
  );
}
