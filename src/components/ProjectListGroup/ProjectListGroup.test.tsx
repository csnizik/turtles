...
// describe('Exception Message is rendered correctly', async () => {
//   beforeEach(() => {
//     const searchInput = {
//       state_county_code: '78',
//     };
//     const stateInput = {
//       stateNameDisplay: 'Virgin Islands',
//       stateCode: '78',
...
//   test('Should display the Exception Message Component', async () => {
//     const { findByText } = render(
//       <ProjectListGroup isMapDisplayed={false} selectedStateName='' />
//     );

//     await findByText(
//       'No related Conservation Innovation Grant data is avaliable at this time.'
//     );
...
//   xtest('Should display the Exception Message title', () => {
